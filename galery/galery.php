...
if ($result) {
    ...
    echo '<div class="row justify-content-center align-items-center m-5">'; // Abre la primera fila
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<div class="col-md-4 mt-4 ">'; // Abre una columna
    ...
    echo '</div>'; // Cierra la primera fila

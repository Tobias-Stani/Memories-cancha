    ...
    if (isset($_POST['update'])) {
        ...
        $fecha = $_POST['fecha'];
        $resultado = $_POST['resultado']; // Añade la actualización del resultado
        $link = $_POST['link'];
        $competencia = $_POST['competencia'];

        $query = "UPDATE partidos SET partido = '$partido', fecha = '$fecha', resultado = '$resultado', link = '$link', competencia = '$competencia' WHERE id = $id";
        mysqli_query($conn, $query);

        $_SESSION['message'] = 'Partido editado correctamente';
...
<div class="col-md-4 mx-auto my-5">
    ...
    <div class="card card-body">
        <form action="edit.php?id=<?php echo $_GET['id']; ?>" method="POST" >
            ...
            <div class="form-group m-3">
                <input type="text" name="resultado" class="form-control" value="<?php echo $resultado; ?>" placeholder="Resultado">
            </div>
            <div class="form-group m-3">
